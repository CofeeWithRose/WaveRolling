...
export class HDWaveRender {
    ...
    constructor(container, options ){
        ...
        this._canvasesContainer = document.createElement('section');
        this._canvasesContainer.style.width = '100%';
        this._canvasesContainer.style.height = container.clientHeight;
